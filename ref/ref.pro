...
SOURCES += src/derp.cpp

HEADERS += src/derp.h

INCLUDEPATH += ../../LevelEd/gameplay/src
INCLUDEPATH += ../../LevelEd/external-deps/include
...
linux: LIBS += -L$$PWD/../../LevelEd/gameplay/Debug/ -lgameplay
linux: LIBS += -L$$PWD/../../LevelEd/external-deps/lib/linux/x86_64/ -lgameplay-deps
linux: LIBS += -lm -lGL -lrt -ldl -lX11 -lpthread -lgtk-x11-2.0 -lglib-2.0 -lgobject-2.0
linux: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../../LevelEd/gameplay/res/shaders ../res$$escape_expand(\n\t))
linux: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../../LevelEd/gameplay/res/ui ../res$$escape_expand(\n\t))
linux: QMAKE_POST_LINK += $$quote(cp -rf $$PWD/../../LevelEd/gameplay/res/logo_powered_white.png ../res$$escape_expand(\n\t))

macx: QMAKE_CXXFLAGS += -x c++ -stdlib=libc++ -w -arch x86_64
macx: QMAKE_OBJECTIVE_CFLAGS += -x objective-c++ -stdlib=libc++ -w -arch x86_64
macx: LIBS += -L$$PWD/../../LevelEd/gameplay/Debug/ -lgameplay
macx: LIBS += -L$$PWD/../../LevelEd/external-deps/lib/macosx/x86_64/ -lgameplay-deps
...
macx: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../../LevelEd/gameplay/res/shaders ../res$$escape_expand(\n\t))
macx: QMAKE_POST_LINK += $$quote(rsync -rau $$PWD/../../LevelEd/gameplay/res/ui ../res$$escape_expand(\n\t))
macx: QMAKE_POST_LINK += $$quote(cp -rf $$PWD/../../LevelEd/gameplay/res/logo_powered_white.png ../res$$escape_expand(\n\t))
macx 
{
    icon.files = icon.png
...
win32: CONFIG(debug, debug|release): LIBS += -L$$PWD/../../LevelEd/gameplay/Debug/debug/ -lgameplay
win32: CONFIG(release, debug|release): LIBS += -L$$PWD/../../LevelEd/gameplay/Release/release/ -lgameplay
win32: CONFIG(debug, debug|release): LIBS += -L$$PWD/../../LevelEd/external-deps/lib/windows/x86_64/Debug/ -lgameplay-deps
win32: CONFIG(release, debug|release): LIBS += -L$$PWD/../../LevelEd/external-deps/lib/windows/x86_64/Release/ -lgameplay-deps
...
win32: QMAKE_POST_LINK += $$quote(xcopy ..\../../LevelEd\gameplay\res\shaders res\shaders\* /s /y /d$$escape_expand(\n\t))
win32: QMAKE_POST_LINK += $$quote(xcopy ..\../../LevelEd\gameplay\res\ui res\ui\* /s /y /d$$escape_expand(\n\t))
win32: QMAKE_POST_LINK += $$quote(copy ..\../../LevelEd\gameplay\res\logo_powered_white.png res$$escape_expand(\n\t))
