...
public:
	...
	unsigned int read(); //this is a call to the circular "pull" function, to get data from maya. 	
	unsigned int handleData(void *& Node); //compare return with enum, and paramater is the returned node.
